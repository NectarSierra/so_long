...
/*   Updated: 2025/03/06 11:00:12 by nsaillez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	declare_player_tiles(t_param *p, void **tiles_list, int w, int h)
{
	...
	tiles_list[0] = p->tiles_e->img_p_r;
	tiles_list[1] = p->tiles_e->img_p_l;
	tiles_list[2] = p->tiles_e->img_p_f;
	tiles_list[3] = p->tiles_e->img_p_b;
}
...
void	declare_objectives_tiles(t_param *p, void **tiles_list, int w, int h)
{
	...
	tiles_list[4] = p->tiles_e->img_e_o;
	tiles_list[5] = p->tiles_e->img_e_c;
	tiles_list[6] = p->tiles_e->img_c;
	tiles_list[7] = p->tiles_e->img_g;
	tiles_list[8] = p->tiles_e->img_w;
	tiles_list[9] = p->tiles_e->img_i_c;
	tiles_list[10] = p->tiles_e->img_i_s;
}
