...
/*   Updated: 2025/03/06 13:14:59 by nsaillez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	pre_draw_map(t_param *param, t_map *map_e)
{
	...
	draw_stats(param, 0, param->map_e->to_collect);
...
void	draw_map(t_param *param, t_map *map_e)
{
	...
	draw_stats(param, param->player_infos[2], param->map_e->to_collect);
